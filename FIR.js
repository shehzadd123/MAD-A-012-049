      ...
      <View style={{alignItems: 'center', width: 400}}>
        <View
          ...
          <View
            ...
            <View style={{marginTop:90, marginLeft:-119}}><Text style={{color:'red', fontWeight:'bold', fontSize:40, fontFamily:'Impact'}}>REPORTING FIR</Text></View>
              <View>
                <Image
          ...
          <View style={{backgroundColor: '#10942e',marginLeft:0, width:370,height:50, borderRadius:8,marginTop:8 }}>
            <TouchableOpacity
              ...
              <Text style={{fontSize:20, marginLeft:100, fontWeight:'bold', color:'white', marginTop:9, alignContent:'center'}}>REGISTER NEW FIR</Text>
            </TouchableOpacity>
          </View>
          <View style={{backgroundColor: '#b8b8b8',marginLeft:0, width:370,height:50, borderRadius:8,marginTop:8 }}>
            <TouchableOpacity  onPress={() => navigation.navigate('VRFu')}>
              <Text style={{fontSize:20, marginLeft:85, fontWeight:'bold', color:'#10942e', marginTop:9}}>VIEW REGISTERED FIR</Text>
            </TouchableOpacity>
          </View>
